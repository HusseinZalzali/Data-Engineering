...
class _CLIGuestTokenManager(GuestTokenManager):
	def __init__(self):
		...
		dir = os.path.join(cacheHome, 'dgpadProject')
			...
			for entry in instruction['entries']:
				if entry['entryId'].startswith('tweet-'):
					if entry['content']['entryType'] == 'TimelineTimelineItem' and entry['content']['itemContent']['itemType'] == 'TimelineTweet':
						...
						base.logger.warning('Got unrecognised timeline tweet item(s)')
...
class TwitterCustomHashtagCollector(TwitterSearchScraper):
